...
This is a demonstrations of sequence paxos as a repeated run of single paxos on a list of value while maintain the order with a series of states in each role. See single-paxos for how to have groups of processes over a shared distributed primitives.
...
int main(int argc, char **argv)
{
    ...
    if (num_procs != 4) {
        fprintf(stderr, "Must use 4 processes for this example\n");
