...
This is a demonstrations of how to implement a leader elction using a variation of the bully algorithm, where the first candidate calls an election and declare themself the leader.

How to run the source code
===========================
mpicc leader-election2.c && mpiexec -n 4 ./a.out
